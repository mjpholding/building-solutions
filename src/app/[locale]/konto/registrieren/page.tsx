    ...
    <div className="min-h-screen bg-swish-gray-50 flex items-center justify-center px-4 py-10">
      <div className="max-w-lg w-full">
        <div className="bg-white rounded-2xl border border-swish-gray-100 p-8 shadow-sm">
          <h1 className="text-2xl font-bold text-swish-gray-900 mb-2">{t("registerTitle")}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-swish-gray-700 mb-1">{t("passwordRepeat")} *</label>
