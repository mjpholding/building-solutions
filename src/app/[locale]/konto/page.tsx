  ...
  if (loading || !customer) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <Loader2 className="w-8 h-8 animate-spin text-swish-gray-300" />
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-swish-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-xl border border-swish-gray-100 p-5">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl border border-swish-gray-100 p-6">
            ...
            {ordersLoading ? (
              <div className="flex items-center justify-center py-10">
                <Loader2 className="w-5 h-5 animate-spin text-swish-gray-300" />
              </div>
            ) : orders.length === 0 ? (
              ...
              <div className="space-y-3">
                {orders.slice(0, 5).map((order) => (
                  <div key={order.id} className="flex items-center justify-between p-3 bg-swish-gray-50 rounded-lg">
                    <div>
