    ...
    <>
      ...
      <div className="no-print fixed top-4 right-4 z-50">
        <button
          ...
          className="bg-red-600 text-white px-5 py-2 rounded-lg text-sm font-semibold shadow-lg hover:bg-red-700"
        >
          Drucken
        </button>
      </div>
      ...
      >
        ...
        <div className="flex justify-between items-start mb-1">
          ...
          <div className="text-right w-[65mm] flex-shrink-0">
            <h1 className="text-[20px] font-bold text-red-600 leading-tight">
